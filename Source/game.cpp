...
void Game::Render() noexcept
{
	...
	case State::GAMEPLAY:
		...
		//player rendering
		player.Render(shipTextures.at(player.activeTexture)); //TODO: always dwaring the first frame. Consider letting Player own the array isntead and decide what texture to draw each frame.
